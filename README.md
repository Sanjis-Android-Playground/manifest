...
1. Initialize your local repository:
    ```bash
    repo init --no-repo-verify --git-lfs -u https://github.com/Sanjis-Android-Playground/manifest.git -b 15 -g default,-mips,-darwin,-notdefault
    ```
   Or If you wish to save some system space and don't care about repo history depths:
    ```bash
    repo init --depth=1 --no-repo-verify --git-lfs -u https://github.com/Sanjis-Android-Playground/manifest.git -b 15 -g default,-mips,-darwin,-notdefault
    ```
